...
public interface DeliveryRecordMapper {
    ...
    @Insert("INSERT INTO delivery_record (company_id, record_date, category, material_name, spec_model, material_code, " +
            "material_serial, quantity, unit, brand, product_attr, factory, shipment_no, `year_month`, created_by, updated_by) " +
    ...
    @Update("UPDATE delivery_record SET record_date=#{recordDate}, category=#{category}, material_name=#{materialName}, " +
            ...
            "shipment_no=#{shipmentNo}, `year_month`=#{yearMonth}, updated_by=#{updatedBy} " +
            "WHERE id=#{id}")
    ...
    @Insert("<script>" +
            ...
            "material_serial, quantity, unit, brand, product_attr, factory, shipment_no, `year_month`, created_by, updated_by) VALUES " +
            ...
            "#{r.yearMonth}, #{r.createdBy}, #{r.updatedBy})" +
            "</foreach>" +
            "</script>")
